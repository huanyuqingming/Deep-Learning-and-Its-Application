...
from .transforms import ScaleAugmentation, ScaleToLimitRange, RotateAugmentation, StretchAugmentation
...
class CROHMEDataset(Dataset):
    def __init__(self, ds, is_train: bool, scale_aug: bool) -> None:
        ...
        if is_train and scale_aug:
            ...
            # trans_list.append(RotateAugmentation(max_angle=AUG_MAX_ANGLE)) 
            # trans_list.append(StretchAugmentation(K_MIN, K_MAX))
